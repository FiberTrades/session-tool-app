...
- **Calendar** — a month calendar of daily results. Each calendar row ends in a **week summary cell** ("Week 1", "Week 2"… with that week's money result); clicking it opens that week's **Weekly Review**. The Weekly Review shows that week's **Leaderboard achievements** under Consistency (rank, points, and the same breakdown as the leaderboard's "How X scored" popup: bias and reviews posted, weekly review, series posted, traded with your bias, the three risk rules, net R). The **Monthly Review** shows the month's Leaderboard achievements at the top of Monthly Insights (it replaced "Patterns worth noting").
