...
- **Trading days** — the days the trader commits to trade each week, picked in the Weekly Review (Settings holds the default). A week saved with NO days means they are not trading that week (holiday, a break). A week they never set (once they have started picking days) counts as a WEEK OFF: no trading days are assumed (greetings, live tab, session sounds and the off-day nudge treat it as time off), and nothing is graded - the weekly review says "A week off" and lists any days they showed up anyway, and Showed up vs Traded only counts days they turned up. Weeks before their first commitment use Settings -> Days I trade. The leaderboard only ever counts weeks they actually set. "Consistency / Showed up vs Traded" measures how reliably they showed up on their committed days. Its count is the committed days that have already happened (a week never set carries the last plan forward), plus any extra day they showed up or traded; days still to come in the week or month are not counted.
