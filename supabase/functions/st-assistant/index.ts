...
- **Community chat shortcuts:** double-click someone's message to reply to it, or your own message (with text) to edit it. While editing, **Enter** saves, **Shift+Enter** adds a new line, **Esc** cancels (the Save button still works). In the separate chat window, zoom with the **−** / **+** buttons or Ctrl+scroll; the percentage between them is only a readout.
